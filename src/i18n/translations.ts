export const translations = {
  de: {
    ...
    hero: {
      ...
      headline: "Maßgefertigte Software, die",
      headlineAccent: "Bestand",
      headlineSuffix: "hat.",
      tagline: "Beratung · Konzept · Code — alles aus einer Hand.",
      sub: "Digitalisierung für Unternehmen: Fullstack-, App- und Beratungsexpertise für den Mittelstand. Ich baue keine Software von der Stange, sondern Lösungen, die zu Ihrem Unternehmen passen – und dort bleiben.",
    ...
    about: {
      ...
      lead: "Seit über fünf Jahren entwickle ich digitale Lösungen für Unternehmen, die mehr wollen als Vorlagen aus dem Baukasten – Lösungen, die wirklich passen.",
    ...
    consulting: {
      ...
      body: "Vielleicht haben Sie ein klares Vorhaben. Vielleicht nur ein Bauchgefühl, dass etwas effizienter laufen könnte. Beides ist ein guter Ausgangspunkt – im Erstgespräch finden wir heraus, was wirklich zu Ihnen passt. Kostenfrei, unverbindlich, ohne Sales-Pitch.",
  ...
  en: {
    ...
    hero: {
      ...
      location: "Schwarzenbek · Hamburg",
      headline: "Bespoke software, built",
      headlineAccent: "to last.",
      headlineSuffix: "",
      tagline: "Consulting · concept · code — all from one source.",
      sub: "Digitalization for businesses: fullstack, app and consulting expertise for the mid-market. I don't build software off the shelf — I build solutions that fit your business, and stay.",
      cta1: "Book a call",
    ...
    about: {
      ...
      headline: "Hi, I'm",
      headlineAccent: "Julian.",
      lead: "For over five years I've been building digital solutions for companies that want more than templates off the shelf – solutions that truly fit.",
    ...
    consulting: {
      ...
      body: "Maybe you have a clear plan. Maybe just a hunch that something could run more efficiently. Both are a good starting point – in a discovery call we find out what actually fits you. Free, no obligation, no sales pitch.",
